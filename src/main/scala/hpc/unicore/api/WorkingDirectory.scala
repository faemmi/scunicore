...
class WorkingDirectory(httpClient: http.Client)(implicit protected val ec: ExecutionContext)
...
object WorkingDirectory {
  def fromUrl(url: String, httpClient: http.Client)(implicit ec: ExecutionContext): WorkingDirectory = {
